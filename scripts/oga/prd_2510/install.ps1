...
$APPSERVER_ENDPOINT = "https://protheus.olamagri.com:6010"
$INSTALATION_ROOT = "c:\Totvs_WebAgent"
$INSTALATION_DIR = (join-path -Path $INSTALATION_ROOT -ChildPath "Totvs2510_Prd")
$WEBAGENT_URL = "https://comottecstore.blob.core.windows.net/`$web/files/oga/Totvs2510_prd.zip"
$TEMP_DIR = [System.IO.Path]::GetTempPath()
$TEMP_FILE = (Join-Path -Path $TEMP_DIR -ChildPath "Totvs2510_prd.zip")
...
function create-Shortcut {
    ...
    $ShortcutFile = (join-path -Path $INSTALATION_DIR -ChildPath "Totvs2510_prd.lnk")
    ...
    $Shortcut.Arguments = "launch `"$APPSERVER_ENDPOINT/webapp/?p=SIGAMDI`&e=producao`&M=1`" --browser=`"$localBrowser`" "
